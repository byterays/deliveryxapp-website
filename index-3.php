...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content" class="no-padding">
			<!-- section begin -->
            <section id="section-intro" class="no-padding autoheight light-text" data-stellar-background-ratio="0.5">
                <div class="center-y">
                    <div class="inner text-center">
                        ...
                        <div class="type-wrap title big">
                            <div class="typed-strings">
                                <p>World Class Logistics</p>
                                <p>Fast Delivery Services</p>
                                <p>Your Freight Partner</p>
                            </div>
                            <span class="typed"></span>
                        </div>
						
						<div class="divider-single"></div>
						<a href="#" class="btn-custom">Get Quote Now</a>
                        <div class="divider-double"></div>
                    </div>
                </div>
            </section>
		  ...
		  <span>10:08 pm</span>
            ...
            <section id="section-welcome">
                <div class="container">
                    <div class="row">
                        ...
                        <p>The word cargo refers in particular to goods or produce being conveyed – generally for commercial gain – by ship, boat, or aircraft, although the term is now often extended to cover all types of freight, including that carried by train, van, truck, or intermodal container. The term cargo is also used in case of goods in the cold-chain, because the perishable inventory is always in transit towards a final end-use, even when it is held in cold storage or other similar climate-controlled facility.</p>
            ...
            <section id="section-news">
                <div class="container">
                    <div class="row">
                        <div class="text-center">
                            <h2 class="wow fadeIn" data-wow-delay="0">Latest News
